---
title: "Deadline dí không cho phép bạn viết code bừa — thực ra là sao?"
...
"Deadline gấp nên mình phải viết tạm" — câu này mình nghe nhiều đến mức nó trở thành một cụm từ phản xạ trong ngành. Dev nói nó. Người có kinh nghiệm nói nó. Tech lead nói nó. Và trong nhiều trường hợp, nó đúng theo một nghĩa nào đó.

Nhưng có một sự khác biệt rất lớn giữa "viết tạm có ý thức" và "viết bừa vì bận."

## Hai loại code nhanh

Khi deadline dí, bạn có hai lựa chọn, và chúng trông giống nhau từ bên ngoài nhưng khác nhau hoàn toàn về hệ quả.

**Loại 1: Tactical shortcut — vay có biết mình đang vay**

Bạn skip một số abstraction, hard-code một giá trị tạm, không viết test cho edge case không urgent. Nhưng bạn biết mình đang làm gì. Bạn comment lại, tạo ticket, hoặc ít nhất là ghi nhớ nó là debt.
...
Đây là technical debt có kiểm soát. Giống như bạn vay tiền để đầu tư — biết mình đang nợ, có kế hoạch trả.

**Loại 2: Viết bừa — vay mà không biết mình đang vay**

Bạn skip validation vì "sau này thêm," duplicate logic vì "copy cho nhanh," bỏ qua exception handling vì "chưa cần." Không comment, không ticket, không nhớ. Hai tháng sau bạn không nhận ra đó là debt — nó trông như feature.
...
Khi deadline dí, bạn có thể compress:
...
Mình muốn nói cụ thể về cái giá này vì nó hay bị underestimate.
...
## Điều mình thực sự muốn bạn nhớ
...
Nhưng "clean" không có nghĩa là perfect. Bạn sẽ luôn có debt. Điều quan trọng là:
...
Code tồn tại lâu hơn sprint. Lâu hơn deadline. Lâu hơn cả những người viết ra nó. Bạn đang viết cho người tiếp theo — và trong nhiều trường hợp, người tiếp theo đó là chính bạn, sáu tháng sau, lúc 11 giờ đêm đang debug production.

## Takeaway

Sau Phần 2 này, mình muốn bạn làm một việc cụ thể: mở codebase HMS, tìm ba chỗ bạn biết là "viết tạm" — không có comment, không có ticket, không ai biết ngoài bạn. Thêm comment giải thích tại sao nó là tạm, và tại sao chưa fix. Đó là bước đầu tiên để debt trở nên visible và có thể kiểm soát.
