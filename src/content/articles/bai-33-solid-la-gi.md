---
title: "SOLID — code chạy được vẫn fail vì bạn chưa hiểu cái này"
...
Loại bug đó có tên: **rigid code** — code cứng đến mức mỗi lần thêm một feature, bạn phải sửa năm chỗ khác. Code mà bạn không dám refactor vì không biết sửa chỗ này sẽ break gì chỗ kia. Code mà sau 6 tháng, chính bạn cũng không còn tự tin mình hiểu nó hoạt động thế nào.

SOLID không phải một lý thuyết để đọc rồi gật đầu. Nó là bộ năm nguyên tắc được đúc kết từ hàng nghìn giờ maintain code xấu — để giúp bạn không phải lặp lại những sai lầm đó.
...
Lý do đơn giản: trong môi trường học, requirement không thay đổi. Thầy giáo ra đề một lần, bạn code một lần, submit một lần. Không ai quay lại yêu cầu bạn "thêm tính năng export PDF vào hệ thống bạn viết hồi tháng trước."
...
Code không được thiết kế để thay đổi sẽ bắt đầu kháng cự. Và mỗi lần kháng cự, bạn sẽ tìm cách hack xung quanh nó thay vì giải quyết đúng gốc rễ. Sau 6 tháng, codebase trở thành một mê cung mà không ai muốn đụng vào.
...
Bạn sẽ sửa tất cả những thứ đó trong cùng một method, trong cùng một class. Và mỗi lần sửa, bạn có thể break bất kỳ thứ gì khác trong method đó mà không hay.
...
**OCP** hỏi: *"Thêm tính năng mới có bắt bạn sửa code cũ không?"* Nếu có — thiết kế chưa đủ mở.

**LSP** hỏi: *"Subclass của bạn có thật sự là một phiên bản của parent không?"* Nếu không — bạn đang kế thừa sai.

**ISP** hỏi: *"Interface bạn implement có method nào bạn không dùng không?"* Nếu có — interface đang quá béo.

**DIP** hỏi: *"Business logic có đang phụ thuộc trực tiếp vào infrastructure không?"* Nếu có — dependency đang chảy sai chiều.

Năm câu hỏi đó, bạn hỏi đủ mỗi lần thiết kế một class, thì code sẽ cứng nhắc ít đi rất nhiều.
...
Áp dụng SRP mù quáng có thể khiến bạn tách code thành hàng chục class nhỏ không ai hiểu tại sao chúng tồn tại. Áp dụng OCP quá sớm có thể tạo ra abstraction layer không cần thiết. Trong SOLID có tension — đôi khi tuân theo nguyên tắc này sẽ vi phạm nguyên tắc kia nếu không cân nhắc.

P04/Bài 07 ở cuối phần này sẽ nói về điều đó. Nhưng trước tiên, bạn cần hiểu từng nguyên tắc đủ sâu để biết mình đang trade-off gì — không phải áp dụng nó như một công thức.

---

## Takeaway

Lần tới khi bạn viết xong một class và nó chạy đúng, đặt câu hỏi này: *"Nếu có năm thứ khác nhau cần thay đổi trong class này theo năm lý do khác nhau — mình có dám sửa một mà không sợ break bốn cái còn lại không?"* Nếu không — đó là dấu hiệu bạn cần đọc tiếp.
