...
description: "MVP không phải là product tệ. MVP là version nhỏ nhất có thể validate được hypothesis. Build đúng thứ trước khi build đúng cách."
category: programming
pubDate: 2024-04-04
series: "Phần 11: Tư duy sản phẩm"
tags: ["product-thinking", "MVP", "startup"]
---
...
Nếu chưa validate được assumption đó, mọi thứ built thêm lên trên đó đều là risk. Có thể đúng, có thể sai — nhưng bạn đang bet mà không có data.
...
Mình thấy một pattern lặp đi lặp lại: feature bắt đầu nhỏ, nhưng trong quá trình discuss và estimate, nó lớn dần.
...
Thứ bạn cần là một câu hỏi filter đơn giản cho mỗi thứ được đề xuất thêm vào: *"Nếu không có cái này, feature core có fail không?"* Nếu không — nó là nice-to-have, không phải must-have, và nó thuộc về sprint sau sau khi validate xong version đơn giản.
...
Trong HMS, mình có một lần phải implement filter appointment theo nhiều criteria cùng lúc — status, doctor, date range, department. Version đầu mình design một query builder dynamic với nhiều combination. Rồi nhìn lại usage thực tế: 80% filter usage chỉ dùng date range + status. Hai cái còn lại dùng rất ít.
...
Với mỗi feature mới, hãy hỏi: *"Version nhỏ nhất có thể cho mình biết feature này có đáng build full không là gì?"* Đó là câu hỏi của product engineer — người biết rằng build đúng thứ quan trọng hơn build thứ đúng.
