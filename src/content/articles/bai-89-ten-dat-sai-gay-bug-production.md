...
description: "Đây là bug tao tìm mất hai tiếng. Không phải vì logic phức tạp. Không phải vì race condition hay distributed state. Mà vì một cái tên."
category: system-design
pubDate: 2024-04-07
series: "Phần 10: Code Sống Sót"
---

Đây là bug tao tìm mất hai tiếng. Không phải vì logic phức tạp. Không phải vì race condition hay distributed state. Mà vì một cái tên.
...
Khi mày đặt tên cho một method, mày đang tạo ra một **contract ngầm** với người sẽ đọc code sau mày. Người đó sẽ đọc tên, suy ra behavior, và quyết định có dùng method đó hay không — thường mà không đọc implementation.
...
Người viết method này biết rõ mình muốn gì — tất cả appointment chưa cancel. Nhưng cái tên không truyền đạt được điều đó. Và ba tháng sau, một người khác (hoặc chính mày) đọc tên và hiểu sai.
...
Spring Data JPA cho phép mày viết method tên từ query. Đây là power feature — nhưng cũng là nơi naming bug hay xuất hiện nhất vì tên method phải match query, và query có thể phức tạp.
...
Câu hỏi mày nên hỏi khi đặt tên:

- Nếu tao đọc tên này mà không đọc implementation, tao có hiểu đúng nó làm gì không?
...
Một cái tên sai không crash hệ thống ngay. Nó âm thầm tạo ra mental model sai trong đầu của người đọc — và cái mental model đó sẽ dẫn đến một quyết định sai trong tương lai. Đặt tên đúng không phải là perfectionism. Nó là documentation rẻ nhất và hiệu quả nhất mày có thể viết.
