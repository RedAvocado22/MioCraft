---
title: "Design Pattern không giúp bạn viết code tốt hơn — nếu bạn dùng nó sai"
...
Trước khi đi vào từng pattern cụ thể, cần hiểu một điều: Design Pattern không phải là thứ bạn "apply vào code." Chúng là **ngôn ngữ chung** để mô tả các giải pháp đã được kiểm chứng cho các vấn đề thường gặp.

Khi một người có kinh nghiệm nói "cái này nên dùng Strategy," họ không nói "đây là template bạn cần copy vào." Họ đang nói: *"Vấn đề bạn đang gặp có một cấu trúc quen thuộc, và đây là cách người ta đã giải quyết nó nhiều lần trước rồi."*
...
Ví dụ trong HMS: giả sử bạn muốn gửi notification khi một appointment được confirm. Cách đơn giản nhất:
...
## Dấu hiệu bạn đang dùng pattern sai

**Pattern là giải pháp trước khi có vấn đề.** Nếu bạn bắt đầu bằng "mình sẽ dùng Strategy pattern cho cái này" thay vì "cái này đang có vấn đề gì" — đó là dấu hiệu đầu tiên.
...
**Bạn không thể giải thích tại sao cần pattern đó.** Nếu ai hỏi "tại sao đây là Strategy chứ không phải if-else?" mà bạn không trả lời được bằng một tình huống cụ thể — thì pattern đó đang là decoration, không phải solution.

---

## Cách đúng để tiếp cận

Viết code đơn giản nhất trước. Khi bạn gặp một trong các dấu hiệu sau, **lúc đó** mới nghĩ đến pattern:
...
Pattern tốt nhất là pattern bạn refactor vào — không phải pattern bạn viết từ đầu.

---

## Takeaway

Lần tới trước khi bạn apply một pattern, hỏi: *"Vấn đề cụ thể nào pattern này đang giải quyết trong code mình đang viết?"* Nếu câu trả lời là "để code trông chuyên nghiệp hơn" — bỏ pattern đi, viết thẳng.

---

*Bài tiếp theo: Template Method — pattern bạn đang dùng hàng ngày mà không biết tên*
