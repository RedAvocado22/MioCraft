---
title: "User không quan tâm code của bạn — họ quan tâm trải nghiệm"
description: "Mình từng rất tự hào về một cái booking flow mình viết. Clean architecture đúng sách, separation of concerns rõ ràng, unit test coverage cao, zero redun..."
category: programming
pubDate: 2024-04-11
series: "Phần 11: Tư duy sản phẩm"
---

Mình từng rất tự hào về một cái booking flow mình viết. Clean architecture đúng sách, separation of concerns rõ ràng, unit test coverage cao, zero redundant query. Người có kinh nghiệm review xong gật đầu: *"Code tốt."*
...
Đây là một gap mà engineer hay bị mù. Chúng ta đánh giá công việc của mình theo tiêu chí kỹ thuật: correctness, performance, maintainability. Nhưng user đánh giá theo một tiêu chí duy nhất: *"Mình dùng được không, và dùng có dễ không?"*
...
Mình thấy nhiều team có tư duy: UX là việc của designer, mình chỉ implement. Tư duy này có vấn đề không phải vì sai về phân công, mà vì nó tạo ra khoảng trống không ai chịu trách nhiệm.
...
Trước khi open PR cho bất kỳ feature nào có UI, mình có một bước bắt buộc: tự tay chạy qua flow như một user không biết gì về implementation.

Không dùng dev tools để check response. Không mở console để xem log. Chỉ nhìn vào màn hình như user nhìn — và tự hỏi: *"Mình có biết hệ thống đang làm gì không? Mình có biết mình nên làm gì tiếp theo không?"*

Cái này tốn khoảng 5 phút. Số lần nó catch ra vấn đề trước khi QA thấy — nhiều hơn bạn nghĩ.

---

## Takeaway

Code quality là thứ mình và teammate đánh giá. User experience là thứ user đánh giá. Và user không quan tâm mình viết code đẹp đến đâu nếu họ không biết cái button vừa làm gì. Hai tiêu chí đó không mâu thuẫn — nhưng chúng không tự động align. Phải chủ động làm cho chúng align.
